...
foo::foo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_mul_ln5_fu_124_p0);
    sensitive << ( in_r_q0 );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_mul_ln5_fu_124_p1);
    sensitive << ( sext_ln5_reg_135 );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_mul_ln5_fu_124_p2);
    sensitive << ( mul_ln5_fu_124_p0 );
    sensitive << ( mul_ln5_fu_124_p1 );

    SC_METHOD(thread_out_r_address0);
    sensitive << ( zext_ln4_reg_153 );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( sext_ln5_2_reg_140 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( mul_ln5_fu_124_p2 );
    ...
    sc_trace(mVcdFile, sext_ln5_reg_135, "sext_ln5_reg_135");
    sc_trace(mVcdFile, sext_ln5_2_fu_103_p1, "sext_ln5_2_fu_103_p1");
    sc_trace(mVcdFile, sext_ln5_2_reg_140, "sext_ln5_2_reg_140");
    ...
    sc_trace(mVcdFile, zext_ln4_reg_153, "zext_ln4_reg_153");
    ...
    sc_trace(mVcdFile, mul_ln5_fu_124_p0, "mul_ln5_fu_124_p0");
...
void foo::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_0_reg_74 = i_reg_148.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_0_reg_74 = ap_const_lv3_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_reg_148 = i_fu_113_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        sext_ln5_2_reg_140 = sext_ln5_2_fu_103_p1.read();
        sext_ln5_reg_135 = sext_ln5_fu_85_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln3_fu_107_p2.read(), ap_const_lv1_0))) {
        zext_ln4_reg_153 = zext_ln4_fu_119_p1.read();
    }
}

void foo::thread_add_ln5_fu_97_p2() {
...
void foo::thread_i_fu_113_p2() {
    i_fu_113_p2 = (!i_0_reg_74.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_0_reg_74.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void foo::thread_icmp_ln3_fu_107_p2() {
    icmp_ln3_fu_107_p2 = (!i_0_reg_74.read().is_01() || !ap_const_lv3_4.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_74.read() == ap_const_lv3_4);
}

void foo::thread_in_r_address0() {
    in_r_address0 =  (sc_lv<2>) (zext_ln4_fu_119_p1.read());
}

void foo::thread_in_r_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void foo::thread_mul_ln5_fu_124_p0() {
    mul_ln5_fu_124_p0 = in_r_q0.read();
}

void foo::thread_mul_ln5_fu_124_p1() {
    mul_ln5_fu_124_p1 =  (sc_lv<8>) (sext_ln5_reg_135.read());
}

void foo::thread_mul_ln5_fu_124_p2() {
    mul_ln5_fu_124_p2 = (!mul_ln5_fu_124_p0.read().is_01() || !mul_ln5_fu_124_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln5_fu_124_p0.read()) * sc_bigint<8>(mul_ln5_fu_124_p1.read());
}

void foo::thread_out_r_address0() {
    out_r_address0 =  (sc_lv<2>) (zext_ln4_reg_153.read());
}
...
void foo::thread_out_r_d0() {
    out_r_d0 = (!sext_ln5_2_reg_140.read().is_01() || !mul_ln5_fu_124_p2.read().is_01())? sc_lv<32>(): (sc_bigint<32>(sext_ln5_2_reg_140.read()) + sc_biguint<32>(mul_ln5_fu_124_p2.read()));
}
...
void foo::thread_sext_ln3_fu_93_p1() {
    sext_ln3_fu_93_p1 = esl_sext<9,8>(c.read());
}

void foo::thread_sext_ln5_1_fu_89_p1() {
    sext_ln5_1_fu_89_p1 = esl_sext<9,8>(b.read());
}

void foo::thread_sext_ln5_2_fu_103_p1() {
    sext_ln5_2_fu_103_p1 = esl_sext<32,9>(add_ln5_fu_97_p2.read());
}

void foo::thread_sext_ln5_fu_85_p1() {
    sext_ln5_fu_85_p1 = esl_sext<32,8>(a.read());
}

void foo::thread_zext_ln4_fu_119_p1() {
    zext_ln4_fu_119_p1 = esl_zext<64,3>(i_0_reg_74.read());
}
