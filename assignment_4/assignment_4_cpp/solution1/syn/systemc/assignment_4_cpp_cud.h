...
// ==============================================================
#ifndef __assignment_4_cpp_cud__HH__
#define __assignment_4_cpp_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(assignment_4_cpp_cud) {
    ...
    SC_CTOR(assignment_4_cpp_cud):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
