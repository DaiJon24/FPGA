...
// ==============================================================
#ifndef __assignment_4_cpp_bkb__HH__
#define __assignment_4_cpp_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(assignment_4_cpp_bkb) {
    ...
    SC_CTOR(assignment_4_cpp_bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
