...
// ==============================================================
#ifndef __assignment_4_ap_sbkb__HH__
#define __assignment_4_ap_sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(assignment_4_ap_sbkb) {
    ...
    ACMP_sdiv_seq<ID, 20, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(assignment_4_ap_sbkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
