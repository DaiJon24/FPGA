...
// ==============================================================
#ifndef __lec10ex1_mul_32s_bkb__HH__
#define __lec10ex1_mul_32s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lec10ex1_mul_32s_bkb) {
    ...
    SC_CTOR(lec10ex1_mul_32s_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
